...
document.addEventListener("DOMContentLoaded", () => {
  // Check if products is available from product-data.js
  if (typeof products === 'undefined') {
    console.error('Products data not loaded. Make sure product-data.js is included before this script.');
    return;
  }
  ...
  function showOrderConfirmation(name, address, phone, email, total) {
    ...
    document.getElementById('order-confirmation').innerHTML = `
      ...
      <p>Your pet supplies order has been placed and will be delivered soon.</p>
